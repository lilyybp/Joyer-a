                ...
                <table>
                  ...
                  <tbody>
                      ...
                      <?php
                        ...
                        $sql = "SELECT h.folio, fecha, pa.nombre_prenda, po.nombre_proceso, operador, tiempo_esperado, tiempo_total, nombre_cliente FROM historial h JOIN prenda pa ON h.prenda = pa.id_prenda JOIN proceso po ON h.proceso = po.id_proceso;";
